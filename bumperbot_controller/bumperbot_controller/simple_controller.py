...
class SimpleController(Node):
    ...
    def __init__(self):
        ...
        # Adding new variables for differntial inverse kinematics
        self.left_wheel_prev_pos_ = 0.0
        self.right_wheel_prev_pos_ = 0.0

        # Adding support varaibles to define odometry(position and orientation)
        self.x_ = 0.0
        self.y_ = 0.0
        self.theta_ = 0.0
        ...
        #gazebo plugin of ros2 control library will publish joint states of wheel on the topic joint_states.
        #In actual, these messages will publish by sensors(encoders)
        self.joint_sub_ = self.create_subscription(JointState,"joint_states", self.jointCallback, 10)    

        # Publishing odometry message on topic so, other nodes can access this message    
