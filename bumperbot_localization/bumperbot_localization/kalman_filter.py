...
class KalmanFilter(Node):
    ...
    def __init__(self):
        ...
        # Subscribers to receive messages coming from Imu and Encoders
        ...
        # Publisher to publish the filtered data after execution of kalman filter
        ...
        # Prior Belief- Gaussian distribution parameters
        self.mean_ = 0.0
        self.variance_ = 1000.0

        # Modeling the uncertainty of the imu sensor and the motion
        # MeasurementUpdate- Gaussian distribution parameters
